...
def unpickle_cifar():
    ...
    for i in range(5):
        cifar1 = unpickle('../data_download/cifar-10-python/cifar-10-batches-py/data_batch_' + str(i + 1))
        if i == 0:
    ...
    target_name = unpickle('../data_download/cifar-10-python/cifar-10-batches-py/batches.meta')
    ...
    # load testset
    cifar_test = unpickle('../data_download/cifar-10-python/cifar-10-batches-py/test_batch')
...
def data_generator(cifar_train, cifar_test, is_normalized = False):
